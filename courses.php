...
<html dir="ltr" lang="pl-PL">
    <head>
        ...
        <meta name="keywords" content="Grape, Grapes, projekt, przyszlosc szkolnictwa, kursy">
    ...
    <body>
        ...
        ?>
        <h1 class="header-login">Twoje kursy:</h1>

        <a class="add-courses" href="add-courses.php">Dodaj kursy -></a>
    </body>
</html>
